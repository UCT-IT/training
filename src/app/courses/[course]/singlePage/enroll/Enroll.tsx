...
const Enroll = ({ singleData }: EnrollProps) => {
  return (
    <div className="w-full bg-white rounded-3xl shadow-md md:sticky md:top-28 self-start lg:-mt-[243px] z-10 px-5 py-10 space-y-5">
      <h3 className="text-3xl font-bold text-tertiary">{singleData.status}</h3>
